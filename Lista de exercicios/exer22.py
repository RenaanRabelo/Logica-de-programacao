...
htrabalhadas = int(input('Digite as horas trabalhadas no mês: '))
salariophora = float(input('Digite o salário por hora: R$'))
...
if htrabalhadas > 160:
    ...
    print('O salário total do funcionário é: R${:.2f}'.format(salariototal))
else:
